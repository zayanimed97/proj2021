															...
															<div class="product-details">
																<div class="content">
																	...
																	<span class="cart-product-info">
																		...
																		x <span id="prct{{$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])}}">{{ App\Models\Product::convertPrice(auth()->guard('web')->user()->IsVendor() ? $product['item']['vendor_price'] : $product['item']['price']) }}</span>
																	</span>
																</div>
