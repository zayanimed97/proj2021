										...
										<div class="product-description">
											<div class="body-area">
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="left-area">
															<h4 class="heading">{{ __('Product Vendor Price') }}*</h4>
														</div>
													</div>
													<div class="col-lg-12">
														<input name="vendor_price" step="0.01" type="number" class="input-field"
															placeholder="{{ __('e.g 10') }}" min="0" value="{{round($data->vendor_price * $sign->value , 2)}}">
													</div>
												</div>
