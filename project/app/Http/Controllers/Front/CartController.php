...
class CartController extends Controller
{
   ...
   public function addtocart($id)
    {
        ...
        if (Auth::guard('web')->check() && Auth::user()->IsVendor()) {
            $prc = $prod->vendor_price + $gs->fixed_commission + ($prod->vendor_price/100) * $gs->percentage_commission ;
        } else {
   ...
   public function addcart($id)
    {
        $prod = Product::where('id','=',$id)->first(['id','user_id','slug','name','photo','size','size_qty','size_price','color','price', 'vendor_price','stock','type','file','link','license','license_qty','measure','whole_sell_qty','whole_sell_discount','attributes']);
