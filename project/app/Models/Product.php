...
class Product extends Model
{
    ...
    public  function setCurrency() {
        ...
        } else {$price = round($price * $curr->value,2);}
    ...
    public function showPrice() {
        ...
        if (Auth::guard('web')->check() && Auth::user()->IsVendor()) {
            $price = $this->vendor_price + $gs->fixed_commission + ($this->price_vendor/100) * $gs->percentage_commission ;
        } else {$price = $this->price + $gs->fixed_commission + ($this->price/100) * $gs->percentage_commission ;}
        }
